...
export class WorkplaceService extends BaseService {
    ...
    workplaceByUserId = async (userId: number): Promise<WorkplaceEntity[]> => await this.workplaceRepo.leftJoinAndSelect('r.workplaceUsers', 'workplaceUsers').where("workplaceUsers.userId = :userId", { userId }).getMany()
